 ...
 ******************************************************************************/
const clock_arm_pll_config_t clock_config_pll_arm = {
        .loopDivider = 98,                        /* PLL loop divider, Fout = Fin * 49 */
        .src = 0,                                 /* Bypass clock source, 0 - OSC 24M, 1 - CLK1_P and CLK1_N */
};
const clock_sys_pll_config_t clock_config_pll_sys = {
...
const clock_enet_pll_config_t clock_config_pll_enet = {
...
void clock_config() {
    ...
    /* Init ARM PLL. */
    CLOCK_InitArmPll(&clock_config_pll_arm);
    /* Bypass for ARM PLL. */
...
#endif
    /* Init System PLL. */
    CLOCK_InitSysPll(&clock_config_pll_sys);
    /* Init System pfd0. */
    ...
    /* Init Enet PLL. */
    CLOCK_InitEnetPll(&clock_config_pll_enet);
    /* Bypass Enet PLL. */
